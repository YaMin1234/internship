...
<body>
    <div id="app">
        ...
        <main class="py-4">
          ...
          <h1>Register</h1>
          <p>Create an account in our site .</p>
           <form class="pure-form pure-form-stacked" action="/users/register" method="post">
            @csrf

            <div class = "container form-group">
            <label for="name">Name</label>
            <input type="text" name="name" class="form-control col-md-5" required>
            </div>
            <div class = "container form-group">
            <label for="email">Email Address</label>
            <input type="email" name="email" class="form-control col-md-5" required>
            </div>
            <div class = "container form-group">
